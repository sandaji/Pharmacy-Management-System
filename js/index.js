...
function validate() {
  ...
  xhttp.open(
    "GET",
    "includes/validateCredentials.php?action=is_admin&uname=" +
      uname +
      "&pswd=" +
      pswd,
    true
...
function validateAndSetup() {
  ...
  if (!validateName(pharmacy_name.value, "pharmacy_name_error"))
    ...
    if (confirmation == "CONFIRM") {
      ...
      xhttp.open(
        "GET",
        "includes/validateCredentials.php?action=store_admin_info&pharmacy_name=" +
          pharmacy_name.value +
          "&address=" +
          address.value +
          "&email=" +
...
function isSetupDone() {
  ...
  xhttp.open(
    "GET",
    "includes/validateCredentials.php?action=is_setup_done",
    false
  );
  xhttp.send();
...
function verifyEmailNumber() {
  ...
  xhttp.open(
    "GET",
    "includes/validateCredentials.php?action=verify_email_number&email=" +
      email +
      "&contact_number=" +
      contact_number,
    false
...
function updateUsernamePassword() {
  ...
  if (!notNull(username.value, "username_error")) username.focus();
    ...
    xhttp.open(
      "GET",
      "includes/validateCredentials.php?action=update_username_password&username=" +
        username.value +
        "&password=" +
        password.value +
        "&email=" +
